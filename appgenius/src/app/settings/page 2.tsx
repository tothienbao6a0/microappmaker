...
import { Key, AlertTriangle, Check, Save, Trash2, ArrowLeft } from 'lucide-react';

// Simple functions to manage API key in localStorage
          ...
          <div className="bg-card border border-border rounded-lg p-6 space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Add your OpenAI API key to enable custom app generation. Your key is stored locally 
                in your browser and sent securely to our backend server for each request. 
                We never store your API key on our servers, and it's only used for the specific 
                requests you make.
              </p>
